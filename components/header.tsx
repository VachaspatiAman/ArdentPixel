...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {isMenuOpen && (
        <motion.div
          className="inset-0 z-50 flex flex-col items-center justify-center bg-gray-900 bg-opacity-90 md:hidden"
          initial={{ opacity: 0, y: -100 }}
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -100}}
          transition={{ duration: 0.3 }}
        >
          <div className="space-y-1 border-t border-gray-800 px-2 pb-3 pt-2 w-full max-w-md"> 
            {[
              { href: "/", label: "Home" },
              { href: "/about", label: "About Us" },
              { href: "/work", label: "Our Work" },
